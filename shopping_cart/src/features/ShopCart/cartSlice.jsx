...
const cartSlice=createSlice({
    name:'cart',
    initialState, //initialState:initialState, In Es6 if both values and key are same then you don't need to mention the keys
    reducers:{
...
export const {addToCart,removeFromCart,applyTempUpdate,updateTempQuantity}=cartSlice.actions;
